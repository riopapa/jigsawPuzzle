...
public class Masks {
    public Bitmap[][] make(Context cxt, int outerSize) {
        ...
        masks[0][0] = piece.maskOut(dMap.make(R.drawable.part0_le), part_le);
        ...
        masks[1][0] = piece.maskOut(dMap.make(R.drawable.part0_ri), part_ri);
        ...
        masks[2][0] = piece.maskOut(dMap.make(R.drawable.part0_up), part_up);
        ...
        masks[3][0] = piece.maskOut(dMap.make(R.drawable.part0_dn), part_dn);
    ...
    public Bitmap[][] makeOut(Context cxt, int outerSize) {
        ...
        masks[0][0] = piece.maskOut(dMap.make(R.drawable.part0_leo), part_le);
        ...
        masks[1][0] = piece.maskOut(dMap.make(R.drawable.part0_rio), part_ri);
        ...
        masks[2][0] = piece.maskOut(dMap.make(R.drawable.part0_upo), part_up);
        ...
        masks[3][0] = piece.maskOut(dMap.make(R.drawable.part0_dno), part_dn);
